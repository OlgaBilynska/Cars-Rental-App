    ...
    <>
      ...
      <HomeWrapperStyled>
        ...
        <HomeSubTextStyled>
          ...
          booking, exceptional service, and a commitment to safety—your
          memorable road trip starts here.
        </HomeSubTextStyled>
        ...
        <HomeTextListStyled>
          ...
          <HomeTextStyled>
            ...
            Our user-friendly online booking system makes it easy to reserve
            your chosen car with just a few clicks. No hidden fees, no
          ...
          <HomeTextStyled>
            ...
            Experience top-notch customer service from our dedicated team. We
            are here to assist you at every step, making your car rental
            experience hassle-free and enjoyable.
          </HomeTextStyled>
          <HomeTextStyled>
            <HomeTextEmphasizedStyled>Safety First:</HomeTextEmphasizedStyled>{" "}
            Your safety is our priority. Our vehicles undergo rigorous
            maintenance checks, and we implement the highest standards to ensure
            a secure and reliable ride. Discover the joy of the open road with
